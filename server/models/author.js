...
module.exports = function (Author) {
  ...
  Author.change_email = function (new_email, confirm_email, password, callback) {
    ...
    Author.findById(user_id, on_find_user);
  };
  ...
  Author.change_password = function (new_password, confirm_password, password, callback) {
